...
public class Dashboard implements Initializable {
   ...
   private TextField searchField;
    ...
    @FXML
    private Circle btnminimize,btnfullScreen;
...
*/
    ...
    void handleButtonAction(ActionEvent event) throws IOException {
        ...
        {
           /* pres_tabname.setCellValueFactory(new PropertyValueFactory<>("Name"));
            pres_tabid.setCellValueFactory(new PropertyValueFactory<>("Patient ID"));
            pres_tabno.setCellValueFactory(new PropertyValueFactory<>("Prescription No."));*/
           ...
           /* try {
                ...
                String query = "SELECT * FROM Prescription WHERE doctor=?";
        ...
        if(event.getSource().equals(pres_add)){
            try{
                ...
                if(rs.next()) {
                    ...
                    dob.setText(new String("DOB: " + rs.getString(6)));

                   /* pres_tabname.setCellValueFactory(new PropertyValueFactory<>("Patient Name"));
                    pres_tabid.setCellValueFactory(new PropertyValueFactory<>("Patient ID"));
                    pres_tabno.setCellValueFactory(new PropertyValueFactory<>("Prescription No.")); */
